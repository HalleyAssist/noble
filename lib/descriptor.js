...
class Descriptor extends events.EventEmitter {
  ...
  static fromDump(noble, entry, peripheral, service, characteristic){
    return new Descriptor(noble, peripheral ? peripheral.id : null, service ? service.uuid : null, characteristic ? characteristic.uuid : null, entry.uuid)
  }
}

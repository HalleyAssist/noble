...
Hci.prototype.setScanParameters = function (interval = 0x0004, window = 0x0004) {
...
Hci.prototype.createLeConn = function (address, addressType, parameters = {}) {
  let { minInterval = 0x0006, maxInterval = 0x28, latency = 0x0000, timeout = 0x00c8, interval } = parameters;

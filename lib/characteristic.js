...
class Characteristic extends events.EventEmitter {
  constructor (noble, peripheralId, serviceUuid, uuid, properties, startHandle = null, valueHandle = null, endHandle = null){
    super()
    this._noble = noble;
  ...
  static fromDump(noble, entry, peripheral, service){
    const ret = new Characteristic(noble, peripheral ? peripheral.id : null, service ? service.uuid : null, entry.uuid, entry.properties, entry.startHandle, entry.valueHandle, entry.endHandle)
...
Characteristic.prototype.notifyAsync = eventRequest.promisify(function(notify, options = {}){
  this._noble.notify(
    this._peripheralId,
    this._serviceUuid,
    this.uuid,
...
Characteristic.prototype.subscribeAsync = function(options = {}){
  return this.notifyAsync(true, options)
}
Characteristic.prototype.unsubscribeAsync = function(options = {}){
  return this.notifyAsync(false, options)
}

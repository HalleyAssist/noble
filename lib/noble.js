...
class Noble extends events.EventEmitter {
  ...
  onCharacteristicsDiscovered(peripheralUuid, serviceUuid, characteristics) {
    const peripheral = this._getPeripheral(peripheralUuid)
    return peripheral.onCharacteristicsDiscovered(serviceUuid, characteristics)
  }
  ...
  onNotify(peripheralUuid, serviceUuid, characteristicUuid, state) {
    const peripheral = this._getPeripheral(peripheralUuid)
    return peripheral.onNotify(serviceUuid, characteristicUuid, state)
  }
